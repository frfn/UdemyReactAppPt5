    ...
    render () {
        ...
        return (
            <div className="NewPost">
                ...
                <label>Title</label>
                <input type="text" value={this.state.title} onChange={(event) => this.setState({title: event.target.value}, () => {console.log(this.state)})} />

                <label>Content</label>
                <textarea rows="4" value={this.state.body} onChange={(event) => this.setState({body: event.target.value}, () => {console.log(this.state)})} />

                {/* drop down box is called SELECT html tag (select box, JComboBox, etc.) */}
                <label>Author</label>
                <select value={this.state.author} onChange={(event) => this.setState({author: event.target.value}, () => {console.log(this.state)})}>
